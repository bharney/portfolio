...
import skydivingImageWebp from '../../images/Skydiving.webp';
				...
				<div className="mt-5 container">
					...
					<div className="about-bio">
						<div className="about-bio-image">
							<OptimizedImage
								src={skydivingImageWebp}
								webpSrc={skydivingImageWebp}
								alt="Brian skydiving - embracing adventure and pushing boundaries"
								width={664}
								height={626}
