			...
			<React.Fragment>
				<div className="mt-5 container">
					...
					<p className="col fs-4">
						...
						era of web experiences. As a software engineer, I've had the privilege of witnessing and
						contributing to this evolution firsthand. Our world is becoming more connected,
					...
					<p className="col fs-4">
						...
						and provide you with valuable insights. Thanks for visiting, and feel free to reach out
						if you have any questions or simply want to chat about tech, Chicago, or, of course,
						Abe!
					</p>
				</div>
			</React.Fragment>
